...
/*Retourne le nom des équipes et le nombre de joueurs par équipe, le tout classé par nom équipe > a 14 soit effectif complet.*/
SELECT 
...
/* Afficher seulement les noms MAIS des equipes avec plus de 14 joueurs, donc COUNT va dans having */
 SELECT 
team.name
FROM 
player
...
/* Liste des joueurs de son équipe qui ont été enrôlés un lundi*/
